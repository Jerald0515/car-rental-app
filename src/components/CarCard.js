    ...
    return car && (
        <div className='group bg-gray-50 p-2 sm:p-5 rounded-3xl m-1 sm:m-5 hover:bg-white hover:border-[1px] cursor-pointer duration-50 border-blue-500'>
            ...
            <div className='flex justify-center'>
                {car.carImage && (
                    <img src={car.carImage.url} alt={car.name} width={220} height={200} className='w-[250px] h-[150px] mb-3 object-contain' />
                )}
            </div>
            ...
            <div className='flex justify-around group-hover:hidden'>
                ...
                <div className='text-center text-gray-500'>
                    ...
                    {car.numberOfSeats && (
                        <h2 className='line-clamp-5 text-[14px] font-light'>{car.numberOfSeats} Seat</h2>
                    )}
                </div>
                <div className='text-center text-gray-500'>
                    <FaGasPump className="w-full text-[22px] mb-2" />
                    {car.carAverage && (
                        <h2 className='line-clamp-5 text-[14px] font-light'>{car.carAverage} MPG</h2>
                    )}
                </div>
            </div>
